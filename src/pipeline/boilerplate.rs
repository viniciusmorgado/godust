...
use crate::utils::{self, template_processing::process_template_file};
...
pub fn generate_godot(
    ...
    const DEFAULT_ICON_SVG: &str = r###"
        ...
        "###;
    // const MAIN_SCENE_TEMPLATE: &str = r#"[gd_scene format=3 uid="{{generate_uid}}"]
    ...
    //     process_template_file(MAIN_SCENE_TEMPLATE, &std::collections::HashMap::new());
    // let main_scene_file = File::create(format!(
    //     "{}/{}/main.tscn",
    //     &godot_kebab_case_name, &godot_kebab_case_name
    // ))?;
    // let mut main_scene_writer = BufWriter::new(main_scene_file);
    // main_scene_writer.write_all(main_scene_content.as_bytes())?;
    // main_scene_writer.flush()?;
